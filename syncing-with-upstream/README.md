...
| Role | Path (example)                         |
|------|----------------------------------------|
| OLD  | `../Altirra-4.50-test20-src` (last synced release)  |
| NEW  | `../Altirra-4.50-test21-src` (target release)       |
...
./tools/sync_diff.sh \
    --old  ../../Altirra-4.50-test20-src \
    --new  ../../Altirra-4.50-test21-src \
    --fork ../
